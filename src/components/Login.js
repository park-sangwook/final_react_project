        ...
        <div className="login-wrap">
            ...
            <div className="login-form" ng-show="!check_login()">
                ...
                <ul className="list-group">
                    ...
                    <li className="list-group-item">
                        <input type="password" id="loginPwd" name="loginPwd" onChange={e=>setPassword(e.target.value)} placeholder="비밀번호 입력(필수)" className="ng-pristine ng-untouched ng-invalid ng-invalid-required" required="required"/>
                    </li>
                </ul>
                <div className="checkbox">
                    ...
                    <span className="inquiry"><a href="#/idinquiry/">아이디 찾기</a> | <a href="#/pwinquiry/">비밀번호 찾기</a></span>
                </div>
            </div>
