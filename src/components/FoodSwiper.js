  ...
  return (
    <div>
        <Swiper navigation={false} modules={[Navigation]} onSwiper={(swiper=>(swiperRef.current = swiper))}className="mySwiper" slidesPerView={4}>
            <SwiperSlide><div className='restaurant-menu-item'><img src="https://images.yogiyo.co.kr/image/yogiyo/STOCK_IMG/%EC%A4%91%EC%8B%9D/%EC%84%B8%ED%8A%B8/%EC%8A%A4%ED%83%81_20201123_DHK%EB%82%B4%EB%B6%80_%EC%A7%9C%EC%9E%A5%EB%A9%B4-%ED%83%95%EC%88%98%EC%9C%A1_Side01_1080x640_LVJM27.jpg?width=384&height=273&quality=100" alt="" /><div className='restaurant-item-title'>1인 set. 탕수육</div><div className='restaurant-item-price'>20000</div></div></SwiperSlide>
